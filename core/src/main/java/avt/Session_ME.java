...
public final class Session_ME implements ISession {
   private static final Session_ME fallback = new Session_ME();
   ...
   /** Session của tab đang active ({@link main.screen.TabContext}). */
   public static Session_ME gI() {
      Session_ME active = main.screen.TabContext.getActiveSession();
