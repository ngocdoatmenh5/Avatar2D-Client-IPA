...
public final class GamePad {
   ...
   public GamePad() {
      ...
      if (Canvas.h >= Canvas.w) {
         ...
         this.e = Canvas.h / 6 << 1;
         Canvas.h -= this.e;
         int baseGameH = Canvas.h;
         int extraDown = 12 * AvMain.hd;
         if (extraDown < 0) {
            extraDown = 0;
         }
         if (extraDown > this.e / 3) {
            extraDown = this.e / 3;
         }
         int mapLift = 8 * AvMain.hd;
         if (mapLift < 0) {
            mapLift = 0;
         }
         if (mapLift > this.e / 4) {
         ...
         this.n = 4;
         this.o = 3;
         this.p = new String[]{"F1", "Top", "CHAT", "F2", "Left", "Down", "Right", "OK"};
         ...
         this.n = 3;
         this.o = 4;
         this.p = new String[]{"F1", "OK", "CHAT", "Top", "Left", "Right", "F2", "Down"};
   ...
   public final void a(Graphics var1) {
      ...
      if (this.isPointerClick) {
         ...
         for(var4 = 0; var4 < var2.p.length; ++var4) {
            ...
            } else if (var2.p[var4].equals("F1") || var2.p[var4].equals("F2")
                  || var2.p[var4].equals("CHAT") || var2.p[var4].equals("OK")) {
               Canvas.normalFont.drawString(var3, var2.p[var4], var5, var6 - 5, 2);
            } else {
