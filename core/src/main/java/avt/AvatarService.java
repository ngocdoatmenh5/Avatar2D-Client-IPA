...
public final class AvatarService extends IService {
   ...
   private static long lastBuy448LockMs;
   private static final long BUY448_LOCK_MS = 1000L;
   ...
   public final void doBuyItem(int var1, int var2) {
      if (var1 == 448 && var2 == 1) {
         ...
         if (now - lastBuy448LockMs < BUY448_LOCK_MS) {
            System.out.println("DEBUG BUYITEM: skip duplicate id=448 (locked)");
            return;
         }
         lastBuy448LockMs = now;
      }
