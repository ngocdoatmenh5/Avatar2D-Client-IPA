...
import main.screen.TabMidletManager;
...
public final class GlobalMessageHandler extends IService implements IMessageHandler {
   ...
   private static GlobalMessageHandler legacyFallback;
   private final MainTab258 ownerTab;
   public IMiniGameMsgHandler miniGameMessageHandler;

   public GlobalMessageHandler(MainTab258 ownerTab) {
      this.ownerTab = ownerTab;
   }

   public static GlobalMessageHandler gI() {
      GlobalMessageHandler active = TabContext.getActiveMessageHandler();
      if (active != null) {
         return active;
      }
      if (legacyFallback == null) {
         legacyFallback = new GlobalMessageHandler(null);
      }
      return legacyFallback;
   }

   private void runInOwnerTab(Runnable action) {
      if (ownerTab == null) {
         action.run();
         return;
      }
      int prevTab = TabContext.getActiveTab();
      boolean restore = prevTab != ownerTab.tabIndex;
      ownerTab.bindGlobals();
      try {
         action.run();
      } finally {
         if (restore) {
            MainTab258 prev = TabMidletManager.instance.getTab(prevTab);
   ...
   public final void onConnectionFail() {
      runInOwnerTab(this::onConnectionFailBody);
   }

   private void onConnectionFailBody() {
   ...
   public final void onDisconnected() {
      runInOwnerTab(this::onDisconnectedBody);
   }

   private void onDisconnectedBody() {
   ...
   public final void onMessage(Message var1) {
      runInOwnerTab(() -> onMessageBody(var1));
   }

   private void onMessageBody(Message var1) {
      int var2;
      int var3;
      int var4;
      String var202;
      ...
      try {
         ...
         switch (var1.command) {
            ...
            case -60:
               ...
               if (var76 != null) {
                  Canvas.inputDlg.setImg(CRes.createImage(var76, 0, var76.length));
               }
         ...
         try {
            ...
            switch (var1.command) {
               ...
               case -4:
                  ...
                  GlobalLogicHandler.isNewVersion = MapScr.isNewVersion;
                  if (ownerTab != null) {
                     ownerTab.syncFromGame();
                  }
