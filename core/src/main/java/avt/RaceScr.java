...
public final class RaceScr extends MyScreen implements IChatable {
   ...
   public final void doOpenRace(PetRace[] var1, short var2, boolean var3, boolean var4) {
      ...
      if (imgWater == null) {
         try {
            this.imgInfo = new FrameImage(CRes.createImage(T.getPath() + "/race/popup/tile1.png"), 20 * AvMain.hd, 20 * AvMain.hd);
            this.imgBackpet = new FrameImage(CRes.createImage(T.getPath() + "/race/popup/bt1.png"), 31 * AvMain.hd, 31 * AvMain.hd);
            this.imgBackMoney = new FrameImage(CRes.createImage(T.getPath() + "/race/popup/bt0.png"), 60 * AvMain.hd, 24 * AvMain.hd);
            this.imgTime = new FrameImage(CRes.createImage(T.getPath() + "/race/popup/time.png"), 14 * AvMain.hd, 14 * AvMain.hd);
            imgWater = CRes.createImage(T.getPath() + "/race/28.png");
            imgFire = CRes.createImage(T.getPath() + "/race/29.png");
            imgBui = new Image[5];

            for(var5 = 0; var5 < 5; ++var5) {
               imgBui[var5] = CRes.createImage(T.getPath() + "/race/bui/d0" + var5 + ".png");
            }

            imgTe = new Image[3];

            for(var5 = 0; var5 < 3; ++var5) {
               imgTe[var5] = CRes.createImage(T.getPath() + "/race/bui/w" + var5 + ".png");
            }
