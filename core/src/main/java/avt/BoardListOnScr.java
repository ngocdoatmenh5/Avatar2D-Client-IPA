...
public final class BoardListOnScr extends MyScreen {
   ...
   public final void switchToMe() {
      ...
      if (imgTitleBoard == null) {
         try {
            imgTitleBoard = CRes.createImage(T.getPath() + "/on/imgkhungsoban.on");
            imgNumPlayer = CRes.createImage(T.getPath() + "/on/imgNumPlayer.on");
            imgPlay = CRes.createImage(T.getPath() + "/on/imgPlay.on");
            imgLock = CRes.createImage(T.getPath() + "/on/imgLock.on");
