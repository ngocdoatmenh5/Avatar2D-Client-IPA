...
public final class AvatarData {
   ...
   private static void setBigImgBB(BigImgInfo var0) {
      Image var1;
      Graphics var2;
      (var2 = (var1 = CRes.createImage(var0.img.getWidth(), var0.img.getHeight())).getGraphics()).setColor(16711935);
   ...
   public static void delErrorRms(String var0) {
      try {
         RecordStore.deleteRecordStore(main.screen.TabContext.rmsKey(var0));
      } catch (Exception var2) {
      }
