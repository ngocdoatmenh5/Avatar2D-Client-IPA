...
public final class CRes {
   ...
   public static void saveRMS(String var0, byte[] var1) throws RecordStoreException {
      var1 = b(var1);
      RecordStore var2;
      if ((var2 = RecordStore.openRecordStore(main.screen.TabContext.rmsKey(var0), true)).getNumRecords() > 0) {
   ...
   private static byte[] loadRMSFromStore(String storeName) {
      try {
         RecordStore var3 = RecordStore.openRecordStore(storeName, false);
         byte[] raw = var3.getRecord(1);
   ...
   public static byte[] loadRMS(String var0) {
      byte[] var1 = loadRMSFromStore(main.screen.TabContext.rmsKey(var0));
      if (var1 == null && main.screen.TabContext.getActiveTab() == 0) {
         var1 = loadRMSFromStore(GameMidlet.APP_VERSION + var0);
         if (var1 != null) {
            try {
               saveRMS(var0, var1);
            } catch (Exception ignored) {
   ...
   public static Image createImage(byte[] var0, byte[] var1) {
      ...
      return createImage(var2);
   }

   public static InputStream getResourceAsStream(String var0) {
      if (main.screen.Main.instance != null) {
         return main.screen.Main.instance.getResourceAsStream(var0);
      }
      return GameMidlet.class.getResourceAsStream(var0.startsWith("/") ? var0 : "/" + var0);
   }
