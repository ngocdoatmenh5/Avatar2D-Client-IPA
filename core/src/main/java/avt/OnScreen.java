...
public final class OnScreen extends MyScreen {
   ...
   public final void switchToMe() {
      ...
      if (l == null) {
         ...
         try {
            ...
            l = new FrameImage(CRes.createImage(T.getPath() + "/on/iconGame0.on"), var1, var1);
            s = CRes.createImage(T.getPath() + "/on/select.on");
            if (OnSplashScr.imgBg == null) {
               OnSplashScr.imgBg = CRes.createImage(T.getPath() + "/on/logo.on");
            }
   ...
   public static void f() {
      if (isOngame && OptionScr.isVirTualKey && !main.lib.DesktopPlatform.isLibGdx()) {
