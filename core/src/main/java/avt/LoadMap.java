...
public final class LoadMap {
   ...
   public final void load(int var1) {
      ...
      if ((var2 = var1 - 1) != 107 && (var2 < 0 || var2 >= bg.length || bg[var2] == -1)) {
         ...
         Graphics var14 = (imgBG = CRes.createImage(96 * AvMain.hd, 96 * AvMain.hd)).getGraphics();
      ...
      if (rememMap != status || imgMap == null) {
         if (var1 - 1 == 19) {
            try {
               rememMap = -1;
               imgMap = new FrameImage(CRes.createImage(avt.T.getPath() + "/wedding.png"), w * AvMain.hd, w * AvMain.hd);
            ...
            try {
               w = 12;
               rememMap = -1;
               imgMap = new FrameImage(CRes.createImage(avt.T.getPath() + "/tileDuaXe.png"), w * AvMain.hd, w * AvMain.hd);
