...
public final class Canvas extends AvCanvasBase implements Runnable, CommandListener {
   ...
   public Canvas() {
      ...
      E = var1.indexOf("RIM") == 0 || var1.indexOf("BlackBerry") == 0;
   ...
   public final void setSize() {
      ...
      if (isKeyBoard) {
         if (main.lib.DesktopPlatform.isLibGdx() && !OptionScr.isVirTualKey) {
            OptionScr.isVirTualKey = true;
         }
         if (OptionScr.isVirTualKey || main.lib.DesktopPlatform.isLibGdx()) {
            z = new GamePad();
         } else {
            G = false;
            z = null;
   ...
   public final void d() {
      ...
      if (!running) {
         running = true;
         Thread loop = new Thread(this, "Canvas-tab-" + System.identityHashCode(this));
         loop.setDaemon(true);
         loop.start();
      }
   }
      ...
      while (running) {
         try {
            if (instance == this) {
               ...
               long target = (long) ClientUtilities.getFrameTargetMs();
               try {
                  if (elapsed < target) {
   ...
   public final void pointerDragged(int var1, int var2) {
   ...
   public final void paintGame(Graphics var1) {
      var1.translate(0, 0);
      if (load != 0) {
         if (currentMyScreen != null) {
