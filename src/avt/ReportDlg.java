...
public final class ReportDlg extends Dialog {
   ...
   public final void a(Graphics var1) {
      GameCanvas.S.a(var1, this.d, this.b, this.e, this.c, 0);
      ...
      for(int var3 = 0; var3 < this.a.size(); ++var3) {
         ...
         if ((var4 = (String)this.a.elementAt(var3)).substring(0, 1).equals("0")) {
            GameCanvas.Q.a(var1, var4.substring(1), this.d + this.e / 2, var2 + 3 + AvMain.ah / 2 - AvMain.ai / 2, 2);
         } else {
            GameCanvas.K.a(var1, var4, this.d + 15, var2 + 3, 0);
         }
