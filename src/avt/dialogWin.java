...
public final class dialogWin extends Face {
   ...
   public final void paint(Graphics var1) {
      ...
      Canvas.smallFontYellow.drawString(var1, "" + this.tienCuoc, this.wPopupWin - 20, var2 + AvMain.ah / 2 - AvMain.hSmall / 2, 1);
      Canvas.normalFont.drawString(var1, "Tiền ăn: ", 10, var2 += AvMain.ah, 0);
      Canvas.smallFontYellow.drawString(var1, "" + this.tienAn, this.wPopupWin - 20, var2 + AvMain.ah / 2 - AvMain.hSmall / 2, 1);
      Canvas.normalFont.drawString(var1, "Tiền thuế: ", 10, var2 += AvMain.ah, 0);
      Canvas.smallFontYellow.drawString(var1, "" + this.tienThue, this.wPopupWin - 20, var2 + AvMain.ah / 2 - AvMain.hSmall / 2, 1);
      Canvas.normalFont.drawString(var1, "Tiền nhận được: ", 10, var2 += AvMain.ah, 0);
      Canvas.smallFontYellow.drawString(var1, "" + this.tienNhanDuoc, this.wPopupWin - 20, var2 + AvMain.ah / 2 - AvMain.hSmall / 2, 1);
      super.paint(var1);
   }
}
