...
public final class TLBoardScr extends BoardScr {
   ...
   private void t() {
      ...
      if (Canvas.w < 150) {
         O = 26;
         P = 32;
         this.S = Canvas.q - Canvas.hTab - 10;
      } else {
         O = 54;
         P = 72;
      }
   ...
   public final void a(int var1, byte var2, Vector var3) {
      ...
      for(var4 = 0; var4 < this.K.size(); ++var4) {
         Card var5;
         (var5 = (Card)this.K.elementAt(var4)).c = Canvas.hw;
         var5.d = (Canvas.h + Canvas.hTab) / 2;
         var5.g = true;
      }
   ...
   public final void a(int var1, byte[] var2, int var3) {
      ...
      if (var1 != -1) {
         ...
         var6 = Canvas.hw + CRes.a.nextInt(20);
         int var16 = Canvas.h / 2 - 20 * AvMain.hd + CRes.a.nextInt(25);
         var10 = var5.length;
         int var11;
