...
public final class MiniMap extends MyScreen {
   ...
   public MiniMap() {
      FilePack.b(T1.aw);
      this.b = FrameImage.a("up", 13 * AvMain.Y, 11 * AvMain.Y);
      FilePack.a();
      FilePack.b(T1.av);
      v = FilePack.a("sIc");
      w = FilePack.a("b_p");
   ...
   public final void a(FrameImage var1, byte[] var2, Vector var3, byte var4, int var5, Command var6) {
      ...
      for(int var7 = 0; var7 < 7; ++var7) {
         G.addElement(new AvPosition(var7 * this.s * this.u / 10 + 50, CRes.e(10) * (this.t * this.u / 10) + 20, CRes.e(2)));
      }
      ...
      if (j) {
         FilePack.b(T1.av);
         H = new FrameImage(FilePack.a("k"), 40 * AvMain.Y, 40 * AvMain.Y);
         FilePack.a();
      }
   ...
   public final void e() {
      this.c = (GameCanvas.m - this.s * this.u) / 2;
      this.d = (GameCanvas.q - GameCanvas.T - this.t * this.u) / 2;
      if (this.c < 0) {
         this.c = 0;
      }
      ...
      A = this.s * this.u - GameCanvas.m;
      E = this.t * this.u - GameCanvas.q;
      if (A < 0) {
         f = 0;
         A = 0;
      }
   ...
   public final void k() {
      ...
      for(int var1 = 0; var1 < G.size(); ++var1) {
         ...
         var10000.a -= var2.c + (GameCanvas.l % 5 == 1 ? 1 : 0);
         if (var2.a < -this.c - 50) {
            var2.a = this.c + CRes.e(4) * 50 + this.s * this.u;
            var2.b = CRes.e(10) * (this.t * this.u / 10) + 10;
            var2.c = CRes.e(2);
         }
      }
   ...
   public final void l() {
      ...
      this.m = false;
      if (GameCanvas.a(0, 0, GameCanvas.m, GameCanvas.n)) {
         int var1 = GameCanvas.k();
         int var2 = GameCanvas.l();
         int var3;
         class_kb var4;
         if (GameCanvas.D == null && GameCanvas.g) {
            GameCanvas.g = false;

            for(var3 = 0; var3 < this.r.size(); ++var3) {
               var4 = (class_kb)this.r.elementAt(var3);
               if (GameCanvas.a(this.c + var4.a * this.u + this.u / 2 - 24 * AvMain.Y - f, this.d + var4.b * this.u - 56 * AvMain.Y - g, 48 * AvMain.Y, 56 * AvMain.Y)) {
                  this.e = var3;
                  return;
               }
            }
         ...
         if (GameCanvas.f) {
            ...
            int var5 = this.N - GameCanvas.i;
            if (var3 < 10) {
               if (B >= 0 && B < E) {
                  this.J = var5 / var3 * 10;
               }

               var5 = this.O - GameCanvas.h;
               if (x >= 0 && x < A) {
                  this.K = var5 / var3 * 10;
               }
            }
            ...
            if (CRes.f(var1) < 10 && CRes.f(var2) < 10) {
               ...
               x = GameCanvas.h + f - GameCanvas.o;
               B = GameCanvas.i + g - GameCanvas.p;
               h();
            }
         }
      }
   ...
   private void g() {
      class_kb var1;
      x = (var1 = (class_kb)this.r.elementAt(this.e)).a * this.u - GameCanvas.m / 2;
      B = var1.b * this.u - GameCanvas.q / 2;
      h();
   }
   ...
   public final void b(Graphics var1) {
      GameCanvas.c(var1);
      var1.setColor(0);
      var1.fillRect(0, 0, GameCanvas.m, GameCanvas.q);
      ...
      for(var2 = 0; var2 < this.r.size(); ++var2) {
         ...
         if (var2 == this.e) {
            ...
            if (j) {
               H.a(var2, var9.a * this.u + this.u / 2, var9.b * this.u - 12 * AvMain.Y, 0, 33, var1);
            } else {
               AvatarData.a(var1, var9.d, var9.a * this.u + this.u / 2, var9.b * this.u - 12 * AvMain.Y, 33);
            }
         } else {
      ...
      for(var4 = 0; var4 < var8.r.size(); ++var4) {
         ...
         if (var7 > g + GameCanvas.q - 20) {
            var7 = g + GameCanvas.q - 20;
         }
         ...
         if (var6 > f + GameCanvas.m - 47) {
            var6 = f + GameCanvas.m - 47;
         }

         GameCanvas.L.a(var10, var5.c, var6 + 10, var7 - (var4 == var8.e ? 70 * AvMain.Y : 35 * AvMain.Y) - var5.e / 3, 2);
      }
      ...
      for(var4 = 0; var4 < G.size(); ++var4) {
         AvPosition var12;
         if ((var12 = (AvPosition)G.elementAt(var4)).a > f - 30 && var12.a < f + 30 + GameCanvas.m && var12.b > g - 20 && var12.b < g + 20 + GameCanvas.n) {
   ...
   public final void a(byte var1, String var2, String var3, String var4) {
      ...
      if (var1 == 0) {
         ...
         if (var1 == 2) {
            ...
            LoginScr.b().c.a(var4);
            LoginScr.b().g();
            GameCanvas.b("Đăng ký thành công.");
            n = null;
         }
