   ...
   public final void paint(Graphics var1) {
      if (super.x * MyObject.hd >= AvCamera.gI().xCam - 10 && this.xCell * MyObject.hd <= AvCamera.gI().xCam + Canvas.w + 10) {
         ...
         if (this.idTree != -1) {
            ...
            if ((this.d <= var5 || var4.dieTime == -1) && this.hervestPer != 100 && this.d >= 0) {
               if (this.isGrass) {
               ...
               if (this.xCell == var2 && this.yCell == var3 || this.time != -1 && this.time == FarmScr.H) {
                  var2 = var2 * 24 * MyObject.hd;
                  var3 = var3 * 24 * MyObject.hd;
                  if (this.time != -1 && this.time == FarmScr.H) {
                  ...
                  long var10 = (long)(var4.harvestTime * 60 - this.d);
                  String var20 = "";
                  if (var8 < 0L) {
                     var8 = 0L;
                  }
                  ...
                  if ((var5 = this.d * 100 / (var4.harvestTime * 60) * 30 / 100) == 0) {
                     var5 = 1;
                  }
                  ...
                  if (var4.harvestTime * 60 - this.d < 0) {
                     var5 = 30;
                  }
