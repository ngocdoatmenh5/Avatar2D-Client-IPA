...
public class Base extends MyObject {
   ...
   public void a(Graphics var1) {
      if (this.O != null && GameCanvas.r != MenuCenter.b()) {
         this.O.a(var1);
      }
   ...
   private void a() {
      if (this.O == null && this.P.size() > 0) {
         this.O = (ChatPopup)this.P.elementAt(0);
   ...
   public final boolean c(int var1, int var2) {
      if (this.H != 0 && this.H != 1) {
         return false;
      } else if (LoadMap.c(super.aw + var1, super.ax + var2) == 90) {
         return false;
      } else {
         int var3 = super.aw;
         if (super.az == 0) {
         ...
         int var5;
         if (var1 != 0) {
            var4 = LoadMap.c(var3 + var1, super.ax - 24);
            var5 = LoadMap.c(var3, super.ax - 24);
            if (var4 == 80 && var5 == 80) {
               this.F = -this.G;
               this.C = var3;
               MapScr.b().n();
            ...
            var1 = LoadMap.c(var3 + var1, super.ax + 24);
            var2 = LoadMap.c(var3, super.ax + 24);
            if (var1 == 80 && var2 == 80) {
               this.F = this.G;
               this.C = var3;
               MapScr.b().n();
            ...
            var4 = LoadMap.c(var3 - 24, super.ax + var2);
            var5 = LoadMap.c(var3 - 24, super.ax);
            if (var4 == 80 && var5 == 80) {
               this.E = -this.G;
               this.D = super.ax;
               MapScr.b().n();
            ...
            var1 = LoadMap.c(var3 + 24, super.ax + var2);
            var2 = LoadMap.c(var3 + 24, super.ax);
            if (var1 == 80 && var2 == 80) {
               this.E = this.G;
               this.D = super.ax;
               MapScr.b().n();
   ...
   public final void a(int var1, String var2, byte var3) {
      this.P.addElement(new ChatPopup(var1, var2, var3));
      this.a();
   }
}
