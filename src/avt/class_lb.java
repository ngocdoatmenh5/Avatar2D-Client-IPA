...
public final class class_lb extends Part {
   ...
   public final void paintAvatar(Graphics var1, int var2, int var3, int var4, int var5) {
      ...
      AvatarData.a(var1, this.a, var7.x0, var7.y0, var7.w, var7.h, var3 + var6.dx[var2] * AvMain.hd - (var5 == Base.LEFT ? (var6.dx[var2] * AvMain.hd << 1) + var7.w * AvMain.hd : 0), var4 + var6.dy[var2] * AvMain.hd, var5, 0);
   }
}
